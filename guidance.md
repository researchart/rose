...
1. _Define your tracking labels_: These labels will be the process marks that track where the review process. 
   - The labels you use may change from conference to conference and might include the following. Note that the first half show the process of the artifact thought the review process and the last five are final decisions (which are added at the end of the review process):
        - 1. InitialInstalls 
        - 2. NeedsFirstReview
        - 3. NeedsSecondReview
        - 4. AuthorComment
...
- Format
  ...
  - _Too complicated._ Reviewers struggled to complete complicated instructions and to test complicated artifacts.
- Execution
